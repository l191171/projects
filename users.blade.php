      ...
      <div class="container-fluid">
        <div class="row mb-0">
          ...
          <div class="col-lg-6">
            ...
            <h1 class="m-0" style="width:2rem; display:flex">Users
            <a class="btn btn-info btn-sm" href="{{route('User')}}"><i class="fas fa-plus"></i> Add User</a>
         </h1>
